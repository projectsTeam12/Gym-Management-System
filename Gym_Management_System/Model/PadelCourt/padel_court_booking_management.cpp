...
void PadelCourtBookingManagement::bookCourt(int memberId, int courtId, tm* bookingTime)
{
...
void PadelCourtBookingManagement::cancelBooking(int memberId, int courtId, tm* bookingTime)
{
	auto it = courtBookings.begin();
...
void PadelCourtBookingManagement::reschedualingCourtBooking(int memberId, int courtId, tm* bookingTime, tm* newTime) {
...
vector<string> PadelCourtBookingManagement::loadDataFromFile() {
...
void PadelCourtBookingManagement::saveDataToFile(vector<string> lines) {
